<article class="main__page page page_{ADMIN_PANEL_PAGE_NAME}" data-name="{PAGE_STATIC_NAME}">
  {PAGE_NAVIGATION}
  <div class="page__title-container">
    <h1 class="page__title">{PAGE_ANALYTICS_PAGE_STATIC_TITLE}</h1>
  ...
  <div class="page__content">
    <div id="analytic-app" class="analytic">
      <div class="analytic__block block block_attendance">
        <h2 class="block__title">{LANG:PAGE_ANALYTICS_BLOCK_PAGE_STATIC_VISITS_TITLE}</h2>
