<tr class="table__row table-pages-static__item" data-page-static-id="{PAGE_STATIC_ID}" data-name="{PAGE_STATIC_NAME}" data-is-published="{PAGE_STATIC_PUBLISHED_STATUS}">
  ...
  <td class="table__cell" rowspan="2">
    <ul class="table-pages-static__item-buttons-list buttons-list list-reset">
      ...
      <li class="buttons-list__item">
        <button class="table-pages-static__item-button" role="page-static-view">
          <svg class="table-pages-static__item-button-icon" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
...
<tr class="table__row table-pages-static__item" data-is-published="{PAGE_STATIC_PUBLISHED_STATUS}">
