  ...
  <table class="table table_settings">
    ...
    <tr class="table__row">
      <td class="table__cell cell cell_additional-fields-title-container" colspan="2">
        <div class="cell__title">
          <div class="cell__title-value">Дополнительные поля профиля</div>
    ...
    <tr class="table__row">
      <td class="table__cell cell" colspan="2">
        <table class="table" role="profile-table-additional-fields">
          <tr class="table__row">
            <th class="table__cell"><div class="cell__title">Тип поля</div></th>
            <th class="table__cell"><div class="cell__title">Наименование</div></th>
            <th class="table__cell"><div class="cell__title">Техническое наименование</div></th>
            <th class="table__cell"><div class="cell__title">Описание</div></th>
          </tr>
          <tr class="table__row">
            <td class="table__cell" role="profile-add-field" colspan="4"></td>
          </tr>
        </table>
      </td>
    </tr>
