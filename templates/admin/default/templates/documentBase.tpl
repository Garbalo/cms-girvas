    ...
    <nav class="admin-panel__navigation admin-navigation">
      <ul class="admin-navigation-list list-reset">
        <li class="admin-navigation-list__item">
          <a href="/admin" class="admin-navigation-list__item-link" title="Главная">
            ...
            <div class="admin-navigation-list__item-label">Главная</div>
          </a>
        </li>
        <li class="admin-navigation-list__item">
          <a href="/admin/entries" class="admin-navigation-list__item-link" title="Записи">
            <svg class="admin-navigation-list__item-icon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" style="enable-background:new 0 0 64 64;" xml:space="preserve">
            ...
            <div class="admin-navigation-list__item-label">Записи</div>
          </a>
        </li>
        <li class="admin-navigation-list__item">
          <a href="/admin/pages" class="admin-navigation-list__item-link" title="Страницы">
            <svg class="admin-navigation-list__item-icon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" style="enable-background:new 0 0 64 64;" xml:space="preserve">
              <polygon points="12.3,16.5 23.3,5.5 50.6,5.5 50.6,0 15.4,0 4.4,10.9 4.4,57.5 12.3,57.5 "/>
              <polygon points="27.9,10 17.6,20.3 17.6,64 60.9,64 60.9,10 "/>
            </svg>
            <div class="admin-navigation-list__item-label">Страницы</div>
          </a>
        </li>
        <li class="admin-navigation-list__item">
        ...
        <li class="admin-navigation-list__item">
          <a href="/admin/modules" class="admin-navigation-list__item-link" title="Модули">
            ...
            <div class="admin-navigation-list__item-label">Модули</div>
          </a>
        </li>
        <li class="admin-navigation-list__item">
          <a href="/admin/templates" class="admin-navigation-list__item-link" title="Шаблоны">
            ...
            <div class="admin-navigation-list__item-label">Шаблоны</div>
          </a>
        </li>
        <li class="admin-navigation-list__item">
          <a href="/admin/configurations" class="admin-navigation-list__item-link" title="Конфигурации CMS">
            ...
            <div class="admin-navigation-list__item-label">Конфигурации CMS</div>
          </a>
        </li>
      </ul>
    </nav>
